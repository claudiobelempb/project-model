...
import static br.com.surb.surb.shared.constants.MessageConstants.*;
...
public class ProductDTO implements Serializable {
  ...
  private Long id;
  @Size(min = 5, max = 60, message = REQUIRED_SIZE_MESSAGE)
  @NotBlank(message = REQUIRED_FIELD)
  private String name;
  private String description;
  @Positive(message = REQUIRED_PRICE_POSITIVO)
  private Double price;
  private String imgUrl;
  private TypeStatus status;
  @PastOrPresent(message = REQUIRED_DATA_PRESENT)
  ...
  public ProductDTO(Long id, String name, String description, Double price, String imgUrl, TypeStatus status,
